defmodule OOTPUtility.Leagues.Team do
  ...
  schema "teams" do
    ...
    belongs_to :division,   OOTPUtility.Leagues.Division, references: :division_id, foreign_key: :division_id
  end

  @doc false
  def changeset(team, attrs) do
    team
    |> cast(attrs, [:team_id, :abbr, :name, :logo_filename, :level, :city_id, :league_id, :conference_id, :division_id])
    |> validate_required([:team_id, :abbr, :name, :logo_filename, :level, :city_id, :league_id, :conference_id, :division_id])
  end
end
