defmodule OOTPUtility.Repo.Migrations.CreateTeamBullpenPitchingStats do
  use Ecto.Migration

  def change do
    create table(:team_bullpen_pitching_stats) do
      add :year, :integer
    ...
    create index(:team_bullpen_pitching_stats, [:team_id])
    create index(:team_bullpen_pitching_stats, [:league_id])
  end
end
