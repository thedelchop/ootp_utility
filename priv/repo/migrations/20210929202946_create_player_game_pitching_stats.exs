defmodule OOTPUtility.Repo.Migrations.CreatePlayerGamePitchingStats do
  use Ecto.Migration

  def change do
    create table(:players_game_pitching_stats) do
      add :at_bats, :integer
      add :balks, :integer
    ...
    create index(:players_game_pitching_stats, [:team_id])
    create index(:players_game_pitching_stats, [:league_id])
    create index(:players_game_pitching_stats, [:player_id])
    create index(:players_game_pitching_stats, [:game_id])
  end
end
