defmodule OOTPUtility.Game.Log.LineTest do
  ...
  describe "#format_raw_text" do
    ...
    @formattable_strings [
      ...
      {"Lined into DP, 1-3 (Line Drive, P)", "Fly out, 1-3 (DP), (Line Drive, P)"},
      ...
      {"Runner from 3rd tries for Home, throw by CF and OUT! 8-6-2", "Runner from 3B out trying for Home, 8-6-2"},
      {"Runner from 2nd tries for 3rd, SAFE, no throw by 1B", "Runner from 2B tags up, advances to 3B"},
      {"Runner from 3rd tries for Home, SAFE, throw by LF to home", "Runner from 3B tags up, advances to Home"},
      {"Runner from 2nd tries for 3rd, SAFE, throw by CF made at trailing runner, OUT! 8-6", "Runner from 2B tags up, advances to 3B, Runner from 1B out trying for 2B, 8-6"},
      {"Runner from 3rd tries for Home, SAFE, throw by CF to trailing runner, OUT at third! 8-4-5", "Runner from 3B tags up, advances to Home, Runner from 2B out trying for 3B, 8-4-5"},
      {"Runner from 3rd tries for Home, SAFE, throw by CF to trailing runner, SAFE at third!", "Runner from 3B tags up, advances to Home, Runner from 2B tags up, advances to 3B"},
      {"Runner from 3rd tries for Home, SAFE, throw by LF to trailing runner, OUT at third! 7-5", "Runner from 3B tags up, advances to Home, Runner from 2B out trying for 3B, 7-5"},
      {"Runner from 2nd tries for 3rd, OUT after rundown.", "Runner from 2B out trying for 3B"},
      {"Runner from 2nd tries for 3rd, SAFE after rundown.", "Runner from 2B tags up, advances to 3B"},
      {"Runner from 2nd tries for 3rd, throw by C and SAFE!", "Runner from 2B tags up, advances to 3B"},
