[
  ...
  {"0-1: GRAND SLAM HOME RUN (Flyball, 7D), Distance : 391 ft",
   "0-1: Home Run, 4R, (Flyball, 7D, 391 ft)"},
  {"3-2: 3-RUN HOME RUN (Flyball, 78XD), Distance : 391 ft",
   "3-2: Home Run, 3R, (Flyball, 78XD, 391 ft)"},
  {"2-1: 2-RUN HOME RUN (Flyball, 7LD), Distance : 344 ft",
   "2-1: Home Run, 2R, (Flyball, 7LD, 344 ft)"},
  {"0-0: 3-RUN HOME RUN (Flyball, 78XD), Distance : 400 ft",
   "0-0: Home Run, 3R, (Flyball, 78XD, 400 ft)"},
  {"0-0: SOLO HOME RUN (Flyball, 9LD), Distance : 341 ft",
   "0-0: Home Run, 1R, (Flyball, 9LD, 341 ft)"},
  {"3-2: SOLO HOME RUN (Flyball, 89XD) (Inside the Park)",
   "3-2: Home Run, 1R, (Flyball, 89XD, Inside the Park)"},
  ...
  {"2-1: SINGLE (Flyball, 8RS) - OUT at second base trying to stretch hit.",
   "2-1: Single, (Flyball, 8RS), [2B]"},
  {"3-2: SINGLE (Popup, 56D)", "3-2: Single, (Popup, 56D)"},
  {"0-0: SINGLE  (Groundball, 56) - runner OUT being hit by batted ball. (infield hit)",
   "0-0: Single, (Groundball, 56) {Runner out, hit by batted ball}"},
  {"0-1: SINGLE  (Groundball, 56D) - runner OUT being hit by batted ball.",
   "0-1: Single, (Groundball, 56D) {Runner out, hit by batted ball}"},
  ...
  {"0-0: Grounds into double play, U4-3 (Groundball, 6M)",
   "0-0: Ground out, U4-3 (DP), (Groundball, 6M)"},
  {"0-1: Grounds into double play, 4-6-3 (Groundball, 4)",
   "0-1: Ground out, 4-6-3 (DP), (Groundball, 4)"},
  {"1-0: Grounds into DOUBLE play, U5-4-3 (Groundball, 5L)",
   "1-0: Ground out, U5-4-3 (DP), (Groundball, 5L)"},
  {"1-0: Grounds into DOUBLE play, U5-4-3", "1-0: Ground out, U5-4-3 (DP), (Groundball, 5)"},
  {"2-1: Lines into TRIPLE play, 5-4-3 (Line Drive, 5)",
   "2-1: Fly out, 5-4-3 (TP), (Line Drive, 5)"},
  ...
  {"3-2: Fielders Choice at 1st, 1-3 (Groundball, P)",
   "3-2: Ground out, 1-3 (FC, 1B), (Groundball, P)"},
  {"1-1: Fielders Choice at 2nd, U6 (Groundball, 6M)",
   "1-1: Ground out, U6 (FC, 2B), (Groundball, 6M)"},
  {"1-2: Fielders Choice at 3rd, 6-5 (Groundball, 6)",
   "1-2: Ground out, 6-5 (FC, 3B), (Groundball, 6)"},
  {"1-0: Fielders Choice attempt at home, Runner SAFE. 6-2 (Groundball, 6)",
   "1-0: Single, 6-2 (Groundball, 6), {Runner safe at home on FC attempt}"},
  ...
  {"3-2: Grounds into fielders choice 4-2 (Groundball, 34)",
   "3-2: Ground out, 4-2 (FC, Home), (Groundball, 34)"},
  {"3-2: Reached via error on a dropped throw from SS, E3 (Groundball, 6M)",
   "3-2: Reached on error by 1B, 6-3 (E3), (Groundball, 6M)"},
  {"0-1: Reached via error on a dropped throw from P, E3 (Groundball, 23)",
   "0-1: Reached on error by 1B, 1-3 (E3), (Groundball, 23)"},
  ...
  {"3-2: Single, Error in OF, E9, batter to second base (Groundball, 3D)",
   "3-2: Single, (Groundball, 3D), {Batter to 2B on E9}"},
  {"3-2: Single, Error in OF, E8, batter to second base (Line Drive, 9LS)",
   "3-2: Single, (Line Drive, 9LS), {Batter to 2B on E8}"},
